...
require "graphql/schema/implementation"
...
module GraphQL
  ...
  class Schema
    ...
    def self.from_definition(string, default_resolve: BuildFromDefinition::DefaultResolve, parser: BuildFromDefinition::DefaultParser, implementation: nil)
      GraphQL::Schema::BuildFromDefinition.from_definition(string, default_resolve: default_resolve, parser: parser, implementation: implementation)
    end
